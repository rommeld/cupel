...
use cupel::generated::cellar::{
    ...
    wine_bottle_service_client::WineBottleServiceClient,
    wine_cellar_service_server::WineCellarServiceServer,
    wine_cellar_service_client::WineCellarServiceClient,
    CreateWineBottleRequest, CreateWineCellarRequest,
    DeleteWineBottleRequest, DeleteWineCellarRequest, GetWineBottleRequest,
    ListWineBottleRequest, UpdateWineBottleRequest, UpdateWineCellarRequest,
    WineColor,
};
...
mod wine_bottle_tests {
    ...
    async fn test_create_wine_bottle() {
        ...
        let response = client.create_wine_bottle(request)
            .await
    ...
    async fn test_create_and_get_wine_bottle() {
        ...
        let create_response = client.create_wine_bottle(create_request)
            .await
            .expect("Failed to create wine bottle")
            .into_inner();
        ...
        let get_response = client.get_wine_bottle(get_request)
            .await
    ...
    async fn test_create_update_and_get_wine_bottle() {
        ...
        let update_response = client.update_wine_bottle(update_request)
            .await
    ...
    async fn test_create_delete_and_get_wine_bottle() {
        ...
        let delete_response = client.delete_wine_bottle(delete_request)
            .await
    ...
    async fn test_list_wine_bottles() {
        ...
        for i in 1..=5 {
            ...
            client.create_wine_bottle(request)
                .await
                .expect("Failed to create wine bottle");
        }
        ...
        let response = client.list_wine_bottle(list_request)
            .await
    ...
    async fn test_list_wine_bottles_excludes_deleted() {
        ...
        client.delete_wine_bottle(delete_request)
            .await
            .expect("Failed to delete wine bottle");
        ...
        let response2 = client.list_wine_bottle(list_request2)
            .await
            .expect("Failed to list wine bottles")
            .into_inner();
...
mod wine_cellar_tests {
    ...
    async fn test_create_wine_cellar() {
        ...
        let response = cellar_client.create_wine_cellar(request)
            .await
    ...
    async fn test_create_and_update_wine_cellar() {
        ...
        let create_response = cellar_client.create_wine_cellar(create_request)
            .await
            .expect("Failed to create wine cellar")
            .into_inner();
        ...
        let update_response = cellar_client.update_wine_cellar(update_request)
            .await
    ...
    async fn test_create_and_delete_wine_cellar() {
        ...
        let delete_response = cellar_client.delete_wine_cellar(delete_request)
            .await
    ...
    async fn test_update_cellar_bottle_associations() {
        ...
        let bottle1_response = bottle_client.create_wine_bottle(bottle1)
            .await
            .expect("Failed to create bottle 1")
            .into_inner();
        let bottle2_response = bottle_client.create_wine_bottle(bottle2)
            .await
            .expect("Failed to create bottle 2")
            .into_inner();
        
        let bottle1_id = bottle1_response.bottle.expect("Bottle 1 should be created").id.clone();
        let bottle2_id = bottle2_response.bottle.expect("Bottle 2 should be created").id.clone();
        ...
        let cellar_response = cellar_client.create_wine_cellar(cellar_request)
            .await
            .expect("Failed to create cellar")
            .into_inner();
        
        let wine_cellar = cellar_response.wine_cellar.expect("Cellar should be created");
        ...
        assert_eq!(update_response.wine_cellar.as_ref().unwrap().bottles.len(), 2);
    }
}
